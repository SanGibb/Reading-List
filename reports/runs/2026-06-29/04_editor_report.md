...
This run adds **6 accepted papers** and does **not** require any undecided dossiers. The selection boundary was the acceptance harness, not a quota.
...
- Collection notes: this run added one accepted paper to each top-level technical branch and significantly improved the repo's evaluation-infrastructure coverage
...
- `Cosmos-Reason1: From Physical Common Sense To Embodied Reasoning`
  ...
  Reason: official and influential, but more useful as background embodied-reasoning context than as a direct fit for the repository's current executable-world, spatial-to-action, or action-model slots.
...
- Source quality: all accepted papers rely on primary or official sources
