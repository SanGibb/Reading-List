...
candidate_id: CAND-0038
branch: D
decision: accepted_for_registry
authors: Apanasevich et al.
year: 2026
venue: arXiv
...
- Project: https://greenvla.github.io/
- Code: not confirmed
- Data / benchmark: https://greenvla.github.io/
- Demo / video: https://greenvla.github.io/
- Official figures: https://greenvla.github.io/

## TL;DR

Green-VLA: Staged Vision-Language-Action Model for Generalist Robots is included because it addresses **generalist robot control across humanoids, mobile manipulators, and fixed-base arms** with a method centered on **five-stage VLA curriculum with multimodal grounding, multi-embodiment pretraining, embodiment adaptation, and RL policy alignment**. For our repository, the important point is not venue alone but that the work gives concrete evidence for vision-language-action models, robot foundation policies, and action-conditioned world models. Main caveat: Hardware-specific parts and data availability need checking.

## Novelty

- What is actually new: combines staged training, embodiment-aware actions, OOD detection, and RL alignment for real deployment.
...
1. Defines a generalist robot control across humanoids, mobile manipulators, and fixed-base arms problem setting that is directly relevant to interactive embodied generation.
2. Introduces the core method: five-stage VLA curriculum with multimodal grounding, multi-embodiment pretraining, embodiment adaptation, and RL policy alignment.
3. Provides evidence through 3000 hours of demonstrations, Simpler BRIDGE WidowX, CALVIN ABC-D, and real-robot evaluations and makes the paper useful for our VLA and World-Action Models branch.
...
- Output: generalist robot control across humanoids, mobile manipulators, and fixed-base arms outputs, represented as generated worlds, executable assets, spatial answers, policy actions, or benchmark scores depending on branch.
...
- Dataset / benchmark: 3000 hours of demonstrations, Simpler BRIDGE WidowX, CALVIN ABC-D, and real-robot evaluations.
...
- Core pipeline: five-stage VLA curriculum with multimodal grounding, multi-embodiment pretraining, embodiment adaptation, and RL policy alignment.
...
- Source: https://greenvla.github.io/
- Render:
  Official figure/demo page: https://greenvla.github.io/
...
|---|---|---|---|
| Primary source exists and is 2024+. | https://arxiv.org/abs/2602.00919 | verified | Year recorded as 2026. |
| Dataset/method/task fields are identifiable. | https://arxiv.org/abs/2602.00919 | verified | Registry fields were extracted from primary or official descriptions. |
| Demo or visual quality decision. | https://greenvla.github.io/ | verified | decision=`adequate`, score=3. |
| Project relevance. | local taxonomy and harness | verified | Useful systems reference for staged VLA training and safety-aware execution. |

## Evidence

- Main metrics: The paper reports a staged curriculum, 3000 hours of demonstrations, multi-embodiment action interface, and real/sim evaluations.
...
- Method limitations: Hardware-specific parts and data availability need checking.
...
- Relevance to interactive embodied generation: Useful systems reference for staged VLA training and safety-aware execution.
