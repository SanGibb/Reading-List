...
- Paper: https://arxiv.org/abs/2510.01623
- Project: https://gigaai-research.github.io/VLA-R1
- Code: https://github.com/GigaAI-research/VLA-R1
- Data / benchmark: https://gigaai-research.github.io/VLA-R1
- Demo / video: https://gigaai-research.github.io/VLA-R1
- Official figures: https://gigaai-research.github.io/VLA-R1

## TL;DR

VLA-R1: Enhancing Reasoning in Vision-Language-Action Models is included because it addresses **vision-language-action reasoning and manipulation** with a method centered on **explicit reasoning enhancement for VLA**. For our repository, the important point is not venue alone but that the work gives concrete evidence for vision-language-action models, robot foundation policies, and action-conditioned world models. Main caveat: Model/code/dataset release timing should be rechecked before depending on it.

## Novelty

- What is actually new: adds reasoning traces/planning to VLA action generation.
...
1. Defines a vision-language-action reasoning and manipulation problem setting that is directly relevant to interactive embodied generation.
2. Introduces the core method: explicit reasoning enhancement for VLA.
3. Provides evidence through reasoning-augmented VLA training examples and makes the paper useful for our VLA and World-Action Models branch.
...
- Output: vision-language-action reasoning and manipulation outputs, represented as generated worlds, executable assets, spatial answers, policy actions, or benchmark scores depending on branch.
...
- Dataset / benchmark: reasoning-augmented VLA training examples.
...
- Core pipeline: explicit reasoning enhancement for VLA.
...
- Source: https://gigaai-research.github.io/VLA-R1
- Render:
  Official figure/demo page: https://gigaai-research.github.io/VLA-R1
...
|---|---|---|---|
| Primary source exists and is 2024+. | https://arxiv.org/abs/2510.01623 | verified | Year recorded as 2025. |
| Dataset/method/task fields are identifiable. | https://arxiv.org/abs/2510.01623 | verified | Registry fields were extracted from primary or official descriptions. |
| Demo or visual quality decision. | https://gigaai-research.github.io/VLA-R1 | verified | decision=`adequate`, score=3. |
| Project relevance. | local taxonomy and harness | verified | bridges target-task predicates and action selection |

## Evidence

- Main metrics: The paper reports RLVR/GRPO post-training, VLA-CoT-13K, and in-domain/OOD/sim/real-robot evaluations.
...
- Method limitations: Model/code/dataset release timing should be rechecked before depending on it.
...
- Relevance to interactive embodied generation: bridges target-task predicates and action selection
...
- Code / checkpoint availability: https://github.com/GigaAI-research/VLA-R1.
