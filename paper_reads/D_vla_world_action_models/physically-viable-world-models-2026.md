...
candidate_id: CAND-0036
branch: D
decision: accepted_for_registry
authors: Physically Viable World Models team
year: 2026
venue: arXiv

## Source Links

- Paper: https://arxiv.org/abs/2605.30542
- Project: https://arxiv.org/abs/2605.30542
- Code: not confirmed
- Data / benchmark: https://arxiv.org/abs/2605.30542
- Demo / video: https://arxiv.org/abs/2605.30542
- Official figures: https://arxiv.org/abs/2605.30542

## TL;DR

Physically Viable World Models is included because it addresses **answer action-outcome queries under physical structure** with a method centered on **physically viable transition model for intervention queries**. For our repository, the important point is not venue alone but that the work gives concrete evidence for vision-language-action models, robot foundation policies, and action-conditioned world models. Main caveat: Conceptual framework; implementation and benchmark artifacts need follow-up.

## Novelty

- What is actually new: requires world models to preserve intervention-relevant physical structure.
...
1. Defines a answer action-outcome queries under physical structure problem setting that is directly relevant to interactive embodied generation.
2. Introduces the core method: physically viable transition model for intervention queries.
3. Provides evidence through conceptual/query-conditioned embodied AI framework and makes the paper useful for our VLA and World-Action Models branch.
...
- Output: answer action-outcome queries under physical structure outputs, represented as generated worlds, executable assets, spatial answers, policy actions, or benchmark scores depending on branch.
...
- Dataset / benchmark: conceptual/query-conditioned embodied AI framework.
...
- Core pipeline: physically viable transition model for intervention queries.
...
- Source: https://arxiv.org/abs/2605.30542
- Render:
  Official figure/demo page: https://arxiv.org/abs/2605.30542
...
|---|---|---|---|
| Primary source exists and is 2024+. | https://arxiv.org/abs/2605.30542 | verified | Year recorded as 2026. |
| Dataset/method/task fields are identifiable. | https://arxiv.org/abs/2605.30542 | verified | Registry fields were extracted from primary or official descriptions. |
| Demo or visual quality decision. | https://arxiv.org/abs/2605.30542 | verified | decision=`not_applicable`, score=0. |
| Project relevance. | local taxonomy and harness | verified | supports the target representation as a query-conditioned physical interface |

## Evidence

- Main metrics: The paper frames world models around intervention queries and physical viability rather than passive video prediction.
...
- Method limitations: Conceptual framework; implementation and benchmark artifacts need follow-up.
...
- Relevance to interactive embodied generation: supports the target representation as a query-conditioned physical interface
