...
candidate_id: CAND-0035
branch: D
decision: accepted_for_registry
authors: World Action Models team
year: 2026
venue: arXiv

## Source Links

- Paper: https://arxiv.org/abs/2605.12090
- Project: https://arxiv.org/abs/2605.12090
- Code: not confirmed
- Data / benchmark: https://arxiv.org/abs/2605.12090
- Demo / video: https://arxiv.org/abs/2605.12090
- Official figures: https://arxiv.org/abs/2605.12090

## TL;DR

World Action Models: The Next Frontier in Embodied AI is included because it addresses **model physical evolution under interventions** with a method centered on **formal definition of action-conditioned world modeling**. For our repository, the important point is not venue alone but that the work gives concrete evidence for vision-language-action models, robot foundation policies, and action-conditioned world models. Main caveat: It is a survey/position paper rather than a runnable model.

## Novelty

- What is actually new: separates reactive VLA from intervention-aware world-action modeling.
...
1. Defines a model physical evolution under interventions problem setting that is directly relevant to interactive embodied generation.
2. Introduces the core method: formal definition of action-conditioned world modeling.
3. Provides evidence through survey/position paper over VLA and world-model research and makes the paper useful for our VLA and World-Action Models branch.
...
- Output: model physical evolution under interventions outputs, represented as generated worlds, executable assets, spatial answers, policy actions, or benchmark scores depending on branch.
...
- Dataset / benchmark: survey/position paper over VLA and world-model research.
...
- Core pipeline: formal definition of action-conditioned world modeling.
...
- Render:
  Official figure/demo page: https://arxiv.org/abs/2605.12090
...
|---|---|---|---|
| Primary source exists and is 2024+. | https://arxiv.org/abs/2605.12090 | verified | Year recorded as 2026. |
| Dataset/method/task fields are identifiable. | https://arxiv.org/abs/2605.12090 | verified | Registry fields were extracted from primary or official descriptions. |
| Demo or visual quality decision. | https://arxiv.org/abs/2605.12090 | verified | decision=`not_applicable`, score=0. |
| Project relevance. | local taxonomy and harness | verified | aligns directly with target-task StateTransition and ValidationReport |

## Evidence

- Main metrics: The paper formalizes action-conditioned world modeling and surveys data/evaluation ecosystems for visual fidelity, physical commonsense, and action plausibility.
...
- Method limitations: It is a survey/position paper rather than a runnable model.
...
- Relevance to interactive embodied generation: aligns directly with target-task StateTransition and ValidationReport
