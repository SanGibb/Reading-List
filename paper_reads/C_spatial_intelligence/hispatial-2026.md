...
- Paper: https://microsoft.github.io/HiSpatial/
- Project: https://microsoft.github.io/HiSpatial/
- Code: https://microsoft.github.io/HiSpatial/
- Data / benchmark: https://microsoft.github.io/HiSpatial/
- Demo / video: https://microsoft.github.io/HiSpatial/
- Official figures: https://microsoft.github.io/HiSpatial/

## TL;DR

HiSpatial: Taming Hierarchical 3D Spatial Understanding in Vision-Language Models is included because it addresses **3D spatial relation and reasoning benchmarks** with a method centered on **hierarchical 3D spatial understanding pipeline and VLM fine-tuning**. For our repository, the important point is not venue alone but that the work gives concrete evidence for 3D reasoning, multi-view understanding, spatial VLMs, and spatial representations for action. Main caveat: It targets VLM spatial reasoning, not executable simulation; generated-world use needs conversion to validators.

## Novelty

- What is actually new: large-scale hierarchical spatial supervision for VLMs.
...
1. Defines a 3D spatial relation and reasoning benchmarks problem setting that is directly relevant to interactive embodied generation.
2. Introduces the core method: hierarchical 3D spatial understanding pipeline and VLM fine-tuning.
3. Provides evidence through about 5M images and over 45M objects converted into 3D spatial VQA pairs and makes the paper useful for our Spatial Intelligence branch.
...
- Output: 3D spatial relation and reasoning benchmarks outputs, represented as generated worlds, executable assets, spatial answers, policy actions, or benchmark scores depending on branch.
...
- Dataset / benchmark: about 5M images and over 45M objects converted into 3D spatial VQA pairs.
...
- Core pipeline: hierarchical 3D spatial understanding pipeline and VLM fine-tuning.
...
- Source: https://microsoft.github.io/HiSpatial/
- Render:
  Official figure/demo page: https://microsoft.github.io/HiSpatial/
...
|---|---|---|---|
| Primary source exists and is 2024+. | https://microsoft.github.io/HiSpatial/ | verified | Year recorded as 2026. |
| Dataset/method/task fields are identifiable. | https://microsoft.github.io/HiSpatial/ | verified | Registry fields were extracted from primary or official descriptions. |
| Demo or visual quality decision. | https://microsoft.github.io/HiSpatial/ | verified | decision=`not_applicable`, score=0. |
| Project relevance. | local taxonomy and harness | verified | useful for spatial relation completion and validation |

## Evidence

- Main metrics: Official CVPR 2026 page reports hierarchical 3D spatial supervision, roughly 5M images, and over 45M object-level spatial annotations.
...
- Method limitations: It targets VLM spatial reasoning, not executable simulation; generated-world use needs conversion to validators.
...
- Relevance to interactive embodied generation: useful for spatial relation completion and validation
...
- Code / checkpoint availability: https://microsoft.github.io/HiSpatial/.
