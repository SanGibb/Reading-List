...
- Project: https://arxiv.org/abs/2510.13375
- Code: not confirmed
- Data / benchmark: https://arxiv.org/abs/2510.13375
- Demo / video: https://arxiv.org/abs/2510.13375
- Official figures: https://arxiv.org/abs/2510.13375

## TL;DR

DepthVLA: Enhancing Vision-Language-Action Models with Depth-Aware Spatial Reasoning is included because it addresses **depth-aware language-conditioned manipulation** with a method centered on **mixture-of-transformers combining VLM, depth transformer and action expert**. For our repository, the important point is not venue alone but that the work gives concrete evidence for 3D reasoning, multi-view understanding, spatial VLMs, and spatial representations for action. Main caveat: Code availability is stated as planned; exact reproducibility is pending.

## Novelty

- What is actually new: adds explicit depth reasoning to VLA with strong real and sim gains.
...
1. Defines a depth-aware language-conditioned manipulation problem setting that is directly relevant to interactive embodied generation.
2. Introduces the core method: mixture-of-transformers combining VLM, depth transformer and action expert.
3. Provides evidence through real-world, LIBERO and Simpler evaluations and makes the paper useful for our Spatial Intelligence branch.
...
- Output: depth-aware language-conditioned manipulation outputs, represented as generated worlds, executable assets, spatial answers, policy actions, or benchmark scores depending on branch.
...
- Dataset / benchmark: real-world, LIBERO and Simpler evaluations.
...
- Core pipeline: mixture-of-transformers combining VLM, depth transformer and action expert.
...
- Source: https://arxiv.org/abs/2510.13375
- Render:
  Official figure/demo page: https://arxiv.org/abs/2510.13375
...
|---|---|---|---|
| Primary source exists and is 2024+. | https://arxiv.org/abs/2510.13375 | verified | Year recorded as 2025. |
| Dataset/method/task fields are identifiable. | https://arxiv.org/abs/2510.13375 | verified | Registry fields were extracted from primary or official descriptions. |
| Demo or visual quality decision. | https://arxiv.org/abs/2510.13375 | verified | decision=`adequate`, score=3. |
| Project relevance. | local taxonomy and harness | verified | supports depth-based scene grounding and precise spatial action |

## Evidence

- Main metrics: The paper reports depth-aware mixture-of-transformers integration and gains on real-world tasks, LIBERO, and Simpler.
...
- Method limitations: Code availability is stated as planned; exact reproducibility is pending.
...
- Relevance to interactive embodied generation: supports depth-based scene grounding and precise spatial action
