...
- Project: https://spatial-stack.github.io/
- Code: https://spatial-stack.github.io/
- Data / benchmark: https://spatial-stack.github.io/
- Demo / video: https://spatial-stack.github.io/
- Official figures: https://spatial-stack.github.io/

## TL;DR

SpatialStack: Layered Geometry-Language Fusion for 3D VLM Spatial Reasoning is included because it addresses **3D spatial reasoning for embodied and physical AI systems** with a method centered on **layered geometry-language fusion that injects multi-level geometric features into a VLM hierarchy**. For our repository, the important point is not venue alone but that the work gives concrete evidence for 3D reasoning, multi-view understanding, spatial VLMs, and spatial representations for action. Main caveat: It is a spatial reasoning model rather than a task generator; role is validator/encoder.

## Novelty

- What is actually new: moves beyond late-stage geometry fusion by stacking hierarchical geometric signals through the language backbone.
...
1. Defines a 3D spatial reasoning for embodied and physical AI systems problem setting that is directly relevant to interactive embodied generation.
2. Introduces the core method: layered geometry-language fusion that injects multi-level geometric features into a VLM hierarchy.
3. Provides evidence through multiple 3D spatial reasoning benchmarks and VLM-SpatialStack training/evaluation data and makes the paper useful for our Spatial Intelligence branch.
...
- Output: 3D spatial reasoning for embodied and physical AI systems outputs, represented as generated worlds, executable assets, spatial answers, policy actions, or benchmark scores depending on branch.
...
- Dataset / benchmark: multiple 3D spatial reasoning benchmarks and VLM-SpatialStack training/evaluation data.
...
- Core pipeline: layered geometry-language fusion that injects multi-level geometric features into a VLM hierarchy.
...
- Source: https://spatial-stack.github.io/
- Render:
  Official figure/demo page: https://spatial-stack.github.io/
...
|---|---|---|---|
| Primary source exists and is 2024+. | https://arxiv.org/abs/2603.27437 | verified | Year recorded as 2026. |
| Dataset/method/task fields are identifiable. | https://arxiv.org/abs/2603.27437 | verified | Registry fields were extracted from primary or official descriptions. |
| Demo or visual quality decision. | https://spatial-stack.github.io/ | verified | decision=`not_applicable`, score=0. |
| Project relevance. | local taxonomy and harness | verified | Good spatial encoder/validator reference for local geometry, global context, and relation checking in generated worlds. |

## Evidence

- Main metrics: Official CVPR 2026 page and arXiv report hierarchical vision-geometry-language fusion and broad 3D spatial reasoning gains.
...
- Method limitations: It is a spatial reasoning model rather than a task generator; role is validator/encoder.
...
- Relevance to interactive embodied generation: Good spatial encoder/validator reference for local geometry, global context, and relation checking in generated worlds.
...
- Code / checkpoint availability: https://spatial-stack.github.io/.
