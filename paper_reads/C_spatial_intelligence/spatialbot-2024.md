...
- Project: https://github.com/BAAI-DCAI/SpatialBot
- Code: https://github.com/BAAI-DCAI/SpatialBot
- Data / benchmark: https://github.com/BAAI-DCAI/SpatialBot
- Demo / video: https://github.com/BAAI-DCAI/SpatialBot
- Official figures: https://arxiv.org/abs/2406.13642

## TL;DR

SpatialBot: Precise Spatial Understanding with Vision Language Models is included because it addresses **spatial VQA and embodied AI tasks** with a method centered on **RGB-D vision-language model for precise spatial understanding**. For our repository, the important point is not venue alone but that the work gives concrete evidence for 3D reasoning, multi-view understanding, spatial VLMs, and spatial representations for action. Main caveat: It is a spatial VLM rather than a generator or robot policy; use it as a validator or representation baseline.

## Novelty

- What is actually new: feeds both RGB and depth to improve metric spatial reasoning.
...
1. Defines a spatial VQA and embodied AI tasks problem setting that is directly relevant to interactive embodied generation.
2. Introduces the core method: RGB-D vision-language model for precise spatial understanding.
3. Provides evidence through SpatialQA and RGB-D spatial-understanding benchmark data and makes the paper useful for our Spatial Intelligence branch.
...
- Output: spatial VQA and embodied AI tasks outputs, represented as generated worlds, executable assets, spatial answers, policy actions, or benchmark scores depending on branch.
...
- Dataset / benchmark: SpatialQA and RGB-D spatial-understanding benchmark data.
...
- Core pipeline: RGB-D vision-language model for precise spatial understanding.
...
- Source: https://arxiv.org/abs/2406.13642
- Render:
  Official figure/demo page: https://arxiv.org/abs/2406.13642
...
|---|---|---|---|
| Primary source exists and is 2024+. | https://arxiv.org/abs/2406.13642 | verified | Year recorded as 2024. |
| Dataset/method/task fields are identifiable. | https://arxiv.org/abs/2406.13642 | verified | Registry fields were extracted from primary or official descriptions. |
| Demo or visual quality decision. | https://github.com/BAAI-DCAI/SpatialBot | verified | decision=`not_applicable`, score=0. |
| Project relevance. | local taxonomy and harness | verified | supports grounding spatial relations from observations |

## Evidence

- Main metrics: The paper reports SpatialQA/SpatialBench and an RGB-D VLM setup for depth-related spatial reasoning and embodied tasks.
...
- Method limitations: It is a spatial VLM rather than a generator or robot policy; use it as a validator or representation baseline.
...
- Relevance to interactive embodied generation: supports grounding spatial relations from observations
...
- Code / checkpoint availability: https://github.com/BAAI-DCAI/SpatialBot.
