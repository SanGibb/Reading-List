...
- Code: https://horizonrobotics.github.io/robot_lab/embodied_gen/index.html
- Data / benchmark: https://horizonrobotics.github.io/robot_lab/embodied_gen/index.html
- Demo / video: https://horizonrobotics.github.io/robot_lab/embodied_gen/index.html
- Official figures: https://horizonrobotics.github.io/robot_lab/embodied_gen/index.html

## TL;DR

EmbodiedGen: Towards a Generative 3D World Engine for Embodied Intelligence is included because it addresses **generate interactive 3D worlds and assets** with a method centered on **generative 3D world engine for embodied intelligence**. For our repository, the important point is not venue alone but that the work gives concrete evidence for interactive assets, scenes, tasks, worlds, and PCG-style simulation data. Main caveat: The engine-style paper covers many modules; per-module quality should be checked before using as a baseline.

## Novelty

- What is actually new: packages multiple generative modules for embodied world construction.
...
1. Defines a generate interactive 3D worlds and assets problem setting that is directly relevant to interactive embodied generation.
2. Introduces the core method: generative 3D world engine for embodied intelligence.
3. Provides evidence through 3D assets, articulated objects, scene and layout generation modules and makes the paper useful for our Interactive Generation and PCG branch.
...
- Output: generate interactive 3D worlds and assets outputs, represented as generated worlds, executable assets, spatial answers, policy actions, or benchmark scores depending on branch.
...
- Dataset / benchmark: 3D assets, articulated objects, scene and layout generation modules.
...
- Core pipeline: generative 3D world engine for embodied intelligence.
...
- Source: https://horizonrobotics.github.io/robot_lab/embodied_gen/index.html
- Render:
  Official figure/demo page: https://horizonrobotics.github.io/robot_lab/embodied_gen/index.html
...
|---|---|---|---|
| Primary source exists and is 2024+. | https://arxiv.org/abs/2506.10600 | verified | Year recorded as 2025. |
| Dataset/method/task fields are identifiable. | https://arxiv.org/abs/2506.10600 | verified | Registry fields were extracted from primary or official descriptions. |
| Demo or visual quality decision. | https://horizonrobotics.github.io/robot_lab/embodied_gen/index.html | verified | decision=`adequate`, score=3. |
| Project relevance. | local taxonomy and harness | verified | generation engine that can consume or be evaluated by a typed interactive-world representation |

## Evidence

- Main metrics: The arXiv abstract and project page describe image-to-3D, text-to-3D, texture, articulated-object, scene, and layout generation modules with URDF/simulation support.
...
- Method limitations: The engine-style paper covers many modules; per-module quality should be checked before using as a baseline.
...
- Relevance to interactive embodied generation: generation engine that can consume or be evaluated by a typed interactive-world representation
...
- Code / checkpoint availability: https://horizonrobotics.github.io/robot_lab/embodied_gen/index.html.
