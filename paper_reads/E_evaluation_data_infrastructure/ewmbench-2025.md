# EWMBench: Evaluating Embodied World Models

candidate_id: CAND-0042
branch: E
decision: accepted_for_registry
authors: EWMBench team
year: 2025
venue: arXiv
...
- Project: https://arxiv.org/abs/2505.09694
- Code: not confirmed
- Data / benchmark: https://arxiv.org/abs/2505.09694
- Demo / video: https://arxiv.org/abs/2505.09694
- Official figures: https://arxiv.org/abs/2505.09694

## TL;DR

EWMBench: Evaluating Embodied World Models is included because it addresses **evaluate scene, motion, semantic and interaction consistency** with a method centered on **multi-dimensional embodied world-model benchmark**. For our repository, the important point is not venue alone but that the work gives concrete evidence for embodied/world benchmarks, robot data infrastructure, evaluation protocols, and reproducibility. Main caveat: Exact scenarios, metrics, and release artifacts need rechecking before central use.

## Novelty

- What is actually new: moves world-model evaluation beyond pixel/video quality.
...
1. Defines a evaluate scene, motion, semantic and interaction consistency problem setting that is directly relevant to interactive embodied generation.
2. Introduces the core method: multi-dimensional embodied world-model benchmark.
3. Provides evidence through embodied world model evaluation scenarios and makes the paper useful for our Evaluation and Data Infrastructure branch.
...
- Output: evaluate scene, motion, semantic and interaction consistency outputs, represented as generated worlds, executable assets, spatial answers, policy actions, or benchmark scores depending on branch.
...
- Dataset / benchmark: embodied world model evaluation scenarios.
...
- Core pipeline: multi-dimensional embodied world-model benchmark.
...
- Source: https://arxiv.org/abs/2505.09694
- Render:
  Official figure/demo page: https://arxiv.org/abs/2505.09694
...
|---|---|---|---|
| Primary source exists and is 2024+. | https://arxiv.org/abs/2505.09694 | verified | Year recorded as 2025. |
| Dataset/method/task fields are identifiable. | https://arxiv.org/abs/2505.09694 | verified | Registry fields were extracted from primary or official descriptions. |
| Demo or visual quality decision. | https://arxiv.org/abs/2505.09694 | verified | decision=`not_applicable`, score=0. |
| Project relevance. | local taxonomy and harness | verified | evaluation philosophy for interactive embodied generation benchmark |

## Evidence

- Main metrics: The benchmark targets scene, motion, semantic, and interaction consistency for embodied world models.
...
- Method limitations: Exact scenarios, metrics, and release artifacts need rechecking before central use.
...
- Relevance to interactive embodied generation: evaluation philosophy for interactive embodied generation benchmark
