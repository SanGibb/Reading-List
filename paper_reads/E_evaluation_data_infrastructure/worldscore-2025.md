...
- Code: https://haoyi-duan.github.io/WorldScore/
- Data / benchmark: https://haoyi-duan.github.io/WorldScore/
- Demo / video: https://haoyi-duan.github.io/WorldScore/
- Official figures: https://haoyi-duan.github.io/WorldScore/

## TL;DR

WorldScore: A Unified Evaluation Benchmark for World Generation is included because it addresses **score quality, consistency, controllability and interactivity** with a method centered on **unified benchmark for world generation**. For our repository, the important point is not venue alone but that the work gives concrete evidence for embodied/world benchmarks, robot data infrastructure, evaluation protocols, and reproducibility. Main caveat: It evaluates next-scene/world generation, not all embodied interaction properties; map metrics carefully to our benchmark.

## Novelty

- What is actually new: multi-dimensional evaluation for generated worlds.
...
1. Defines a score quality, consistency, controllability and interactivity problem setting that is directly relevant to interactive embodied generation.
2. Introduces the core method: unified benchmark for world generation.
3. Provides evidence through world generation outputs and scoring dimensions and makes the paper useful for our Evaluation and Data Infrastructure branch.
...
- Output: score quality, consistency, controllability and interactivity outputs, represented as generated worlds, executable assets, spatial answers, policy actions, or benchmark scores depending on branch.
...
- Dataset / benchmark: world generation outputs and scoring dimensions.
...
- Core pipeline: unified benchmark for world generation.
...
- Source: https://haoyi-duan.github.io/WorldScore/
- Render:
  Official figure/demo page: https://haoyi-duan.github.io/WorldScore/
...
|---|---|---|---|
| Primary source exists and is 2024+. | https://arxiv.org/abs/2504.00983 | verified | Year recorded as 2025. |
| Dataset/method/task fields are identifiable. | https://arxiv.org/abs/2504.00983 | verified | Registry fields were extracted from primary or official descriptions. |
| Demo or visual quality decision. | https://haoyi-duan.github.io/WorldScore/ | verified | decision=`not_applicable`, score=0. |
| Project relevance. | local taxonomy and harness | verified | baseline for interactive embodied generation benchmark metrics |

## Evidence

- Main metrics: The benchmark includes 3000 test examples and evaluates controllability, quality, and dynamics across 19 representative world-generation models.
...
- Method limitations: It evaluates next-scene/world generation, not all embodied interaction properties; map metrics carefully to our benchmark.
...
- Relevance to interactive embodied generation: baseline for interactive embodied generation benchmark metrics
...
- Code / checkpoint availability: https://haoyi-duan.github.io/WorldScore/.
